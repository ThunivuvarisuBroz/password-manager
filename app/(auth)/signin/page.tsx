...
const SignUpPage = () => {
  ...
  const [signin, setSignin] = useState({ 'fullname': '', 'email': '', 'phone': '', 'dob': '', 'password': '', 'cnf_password': '' })
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="John Doe" name='fullname' className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" onChange={dataChnage} />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="email" placeholder="john@example.com" name='email' className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" onChange={dataChnage} />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="tel" placeholder="+1 234 567 890" name='phone' className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" onChange={dataChnage} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="date" name='dob' className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-700" onChange={dataChnage} />
                </div>
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    name='password'
                    className="w-full pl-10 pr-12 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" onChange={dataChnage}
                  />
                  <button
                    type="button"
                    onClick={() => setShowPass((prev) => ({ ...prev, pass: !prev.pass }))}
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    onClick={() => setShowPass((prev) => ({ ...prev, cnfPass: !prev.cnfPass }))}
                    className="absolute right-3 top-3 text-gray-400 hover:text-gray-600"
                  >
                    {showPass.cnfPass ? <EyeOff size={20} /> : <Eye size={20} />}
                  </button>
                </div>
              </div>
            </div>
